...
void ListPanel_animate(struct ListPanel *p, Anim *a);
void GridPanel_animate(struct GridPanel *p, Anim *a);
void ScrollPanel_animate(struct ScrollPanel *p, Anim *a);
void SectionPanel_animate(struct SectionPanel *p, Anim *a);
void LayeredPanel_animate(struct LayeredPanel *p, Anim *a);
